...
class Maze:
    ...
    def get_valid_actions(self, agent):
        # use this method to retrieve the list of possible actions for an agent the method checks if surrounding
        # states are "walkable" and if the agent is not going out of the maze dimensions. The method returns the list
        # of actions
        action_list = []
